...
class TaskData extends ChangeNotifier {
  ...
  Future<void> addTask(String newTaskTitle, BuildContext context) async {
    ...
    await hiveTaskBox.put(dataKey, _tasks).whenComplete(
        () => promptSnackBar(context: context, prompt: "Task added"));
  ...
  Future<void> updateTask(Task task, BuildContext context) async {
    ...
    task.toggleDone();
    if (task.isDone == true) {
      promptSnackBar(context: context, prompt: "Kudos! you finished the task");
    }
  ...
  Future<void> deleteTask(Task task, BuildContext context) async {
    ...
    await hiveTaskBox.put(dataKey, _tasks).whenComplete(
        () => promptSnackBar(context: context, prompt: "Task deleted"));
